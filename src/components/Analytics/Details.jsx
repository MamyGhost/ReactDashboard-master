...
export default function Details() {
   const [count, setCount] = useState(0);
	...
	const getDetails= (ids,region) =>{
		fetch('http://localhost:8090/wb/userfront/signalement/description?description=grave accident de&idregion='+region+'', {
			headers:{
...
// 			'Authorization': 'Bearer 7439134adf0568ce88e45c4f04d20e4dafc0531e'
// 		  };
// 	  fetch('http://localhost:8090/wb/userfront/region/7439134adf0568ce88e45c4f04d20e4dafc0531e/signalement', {headers})
// 	  .then((res)=>res.json())
// 	  .then((res)=>{
// 		console.log(res)
